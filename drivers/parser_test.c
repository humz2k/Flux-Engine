...
int main() {
    ...
    fluxParsedScene testScene =
        parser_read_scene("/Users/humzaqureshi/GitHub/Flux-Engine/project/"
                          "scenes/testScene.scene");

    parser_delete_parsed_scene(testScene);
    // fluxParsedPrefab parsed_prefab =
    // parser_read_prefab("/Users/humzaqureshi/GitHub/Flux-Engine/project/prefabs/testPrefab.prefab");
