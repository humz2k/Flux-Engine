...
FLUX_PRIVATE_INCLUDES := -I$(TOOLS_DIR)/include -I$(RAYLIB_DIR) -I$(ENGINE_DIR) -I$(PROJECT_DIR) -I$(EDITOR_DIR) -I$(RENDERER_DIR) -I$(ODE_INCLUDE) -I$(ENET_INCLUDE) -I$(PARSERS_DIR) -I$(HELPERS_DIR)
...
$(BUILD_DIR)/%: $(DRIVERS_DIR)/%.c $(OUTPUTS) $(RAYLIB_DIR)/libraylib.a $(ODE_LIB) $(ENET_LIB) $(PROJECT_DIR)/main.c
