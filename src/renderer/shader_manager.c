...
void render_load_default_shader(void){
    ...
    skybox_loaded = 0;
    flux_default_shader = LoadShader("src/renderer/shaders/lights.vs","src/renderer/shaders/lights.fs");
    ...
    flux_empty_shader = LoadShader("src/renderer/shaders/lights.vs","src/renderer/shaders/empty_lights.fs");
...
void render_load_skybox(const char* path){
    ...
    skybox_loaded = 1;
    skybox_shader = LoadShader("src/renderer/shaders/skybox.vs","src/renderer/shaders/skybox.fs");
