...
#define EDITOR_TOP_TOOL_BAR_RECT make_rect(make_coord(make_pos_pixel(0),make_pos_pixel(0)),make_coord(make_pos_relative(1),make_pos_pixel(EDITOR_TOOL_BAR_SIZE)))
#define EDITOR_SIDE_TOOL_BAR_RECT make_rect(make_coord(make_pos_pixel(0),make_pos_pixel(EDITOR_TOOL_BAR_SIZE)),make_coord(make_pos_pixel(EDITOR_TOOL_BAR_SIZE),make_pos_relative(1)))
