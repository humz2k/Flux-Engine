...
void draw_editor_rect_shadow(editorRect rect, Color color, Vector2 offset,
    ...
    if (top) {
        ...
        DrawRectangleGradientEx(top_shadow_rect, (Color){0, 0, 0, 0}, BLACK,
                                BLACK, (Color){0, 0, 0, 0});
    }
    if (bottom) {
        ...
        DrawRectangleGradientEx(bottom_shadow_rect, BLACK, (Color){0, 0, 0, 0},
                                (Color){0, 0, 0, 0}, BLACK);
    }
    if (right) {
        ...
        DrawRectangleGradientEx(right_shadow_rect, BLACK, BLACK,
    ...
    if (left) {
        ...
        DrawRectangleGradientEx(left_shadow_rect, (Color){0, 0, 0, 0},
    ...
    if (right && bottom) {
        ...
        DrawRectangleGradientEx(rb_corner_rect, BLACK, (Color){0, 0, 0, 0},
                                (Color){0, 0, 0, 0}, (Color){0, 0, 0, 0});
    }
    if (right && top) {
        ...
        DrawRectangleGradientEx(rt_corner_rect, (Color){0, 0, 0, 0}, BLACK,
                                (Color){0, 0, 0, 0}, (Color){0, 0, 0, 0});
    }
    if (left && bottom) {
        ...
        DrawRectangleGradientEx(lb_corner_rect, (Color){0, 0, 0, 0},
                                (Color){0, 0, 0, 0}, (Color){0, 0, 0, 0},
                                BLACK);
    }
    ...
    if (left && top) {
        ...
        DrawRectangleGradientEx(lt_corner_rect, (Color){0, 0, 0, 0},
                                (Color){0, 0, 0, 0}, BLACK,
                                (Color){0, 0, 0, 0});
    }
}
...
bool vector_in_editor_rect(editorRect rect, Vector2 offset, Vector2 coord) {
    ...
    pix_rect.y += offset.y;
    if (pix_rect.width > 0) {
        if (coord.x < pix_rect.x)
            return false;
        if ((coord.x - pix_rect.x) > pix_rect.width)
            return false;
    } else {
        if (coord.x > pix_rect.x)
            return false;
    ...
    if (pix_rect.height > 0) {
        if (coord.y < pix_rect.y)
            return false;
        if ((coord.y - pix_rect.y) > pix_rect.height)
            return false;
    } else {
        if (coord.y < pix_rect.y)
            return false;
